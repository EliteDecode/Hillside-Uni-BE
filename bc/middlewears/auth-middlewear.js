...
const ProtectStaffRoute = async (req, res, next) => {
  let token;
  ...
  if (
    ...
    try {
      ...
      const query =
        "SELECT id, firstname, lastname, email FROM staff WHERE id = ?";
...
module.exports = { mainAdminProtectRoute, ProtectRoute, ProtectStaffRoute };
